...
#define MAX_SLOTS           3
#define MAX_RETRY           3
#define MAX_DISPENSE_QUANTITY   10  // safety limit per command
...
#define RETRY_DELAY_MS          500     // delay between retry attempts
#define IR_POLL_INTERVAL_MS     10      // how often to poll IR sensor
